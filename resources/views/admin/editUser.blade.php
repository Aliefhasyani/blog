        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm mx-auto sm:rounded-lg" style="max-width: 1220px;">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" required autofocus autocomplete="name"  value="{{ $users->name  }}"/>
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <x-input-label for="role" value='Role'value="{{ $users->role  }}" />
            ...
            <div class="p-6">
                ...
                <button type="submit" class="btn btn-primary shadow-lg; bi bi-person-add">Save Changes</button>
            </div>
        </div>
    </form>
